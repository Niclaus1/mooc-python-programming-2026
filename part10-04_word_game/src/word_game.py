...
class RockPaperScissors(WordGame):
    ...
    def round_winner(self, player1_word, player2_word):
        ...
        if player1_word in rules and player2_word not in rules:
            return 1
        elif player1_word not in rules and player2_word in rules:
            return 2
        elif player1_word not in rules and player2_word not in rules:
            return 0
